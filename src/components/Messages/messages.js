export default {
  ...
  updatedSuccessfully: 'Workout successfully updated!',
  updateFailed: 'Update failed',
  workoutCreated: 'Workout successfully created!',
  createFailed: 'Workout creation failed!',
  deletedSuccessfully: 'Deleted successfully',
  somethingFailed: 'Ups! Something went wrong'
}
